...
class GradingPage(CoursePage):
    ...
    def move_grading_range_by_offset(self, letter, offsetX=0, offsetY=0):
        """
        ...
        action.drag_and_drop_by_offset(draggable, offsetX, offsetY).release().perform()
    ...
    def _get_index_of(self, css, expected_key):
        ...
        """
        for i, element in enumerate(self.q(css=css)):
